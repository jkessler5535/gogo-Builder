    ...
    >
      <g clipPath="url(#clip0_1620_271)">
        ...
        <path
          ...
          strokeMiterlimit="10"
          strokeWidth="2"
          d="M237.422 472h105.371c5.996-10.858 9.477-23.692 9.477-37.461 0-38.951-27.829-70.539-62.164-70.539s-62.164 31.573-62.164 70.539c0 13.766 3.474 26.606 9.48 37.461z"
        ></path>
        <path
          fill={color}
          d="M263 370.81c-26.953 12.1-46 41.779-46 76.486 0 16.06 4.079 31.04 11.132 43.704H263V370.81zM317 491h34.871C358.913 478.333 363 463.359 363 447.296c0-34.694-19.047-64.38-46-76.483V491z"
        ></path>
        <path
          stroke="#221F20"
          strokeLinecap="round"
        ...
        <path
          ...
          strokeMiterlimit="10"
          strokeWidth="2"
          d="M330.144 451.236c3.394 0 6.144-2.739 6.144-6.118 0-3.379-2.75-6.118-6.144-6.118-3.393 0-6.144 2.739-6.144 6.118 0 3.379 2.751 6.118 6.144 6.118zM330.144 426.236c3.394 0 6.144-2.739 6.144-6.118 0-3.379-2.75-6.118-6.144-6.118-3.393 0-6.144 2.739-6.144 6.118 0 3.379 2.751 6.118 6.144 6.118z"
        ></path>
        <path
          fill={color}
          stroke="#231F20"
          strokeMiterlimit="10"
          strokeWidth="2"
          d="M309 460.347l-19 18.23-19-18.23 19-71.77 19 71.77z"
        ></path>
        <path
          fill={color}
          stroke="#231F20"
          strokeMiterlimit="10"
          strokeWidth="2"
          d="M296.284 415.577c.532 0 1.042-.212 1.417-.589l9.893-9.93a2.002 2.002 0 000-2.824l-16.177-16.235a2 2 0 00-2.834 0l-16.177 16.235a2.002 2.002 0 000 2.824l9.893 9.93c.375.377.885.589 1.417.589h12.568z"
        ></path>
        <path
          fill="#fff"
          stroke="#231F20"
          strokeMiterlimit="10"
          strokeWidth="2"
          d="M289.096 384.094l-22.385-22.386a1 1 0 00-1.414 0l-22.386 22.386a1 1 0 000 1.414l22.386 22.385a.999.999 0 001.414 0l22.385-22.385a.999.999 0 000-1.414zM336.526 384.092l-22.385-22.385a1.002 1.002 0 00-1.415 0l-22.385 22.385a1.002 1.002 0 000 1.415l22.385 22.385c.391.39 1.024.39 1.415 0l22.385-22.385a1 1 0 000-1.415z"
        ></path>
      </g>
      <defs>
